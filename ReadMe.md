...
We build in an iterative fashion, step by step. Do not proceed with steps until you ask. Remember to continuously update the readme as sensible. Create an Overview.MD that you will update with top level overview of the project, the programs and their functions, and educational bits explaining the formulas or science behind what we are doing.

**📋 See [ITERATIVE_PLAN.md](ITERATIVE_PLAN.md) for the complete development plan.** 

### Requirements
#Robust testing and logging features throughout. Ask pleanty of questions about my hardware. 
This is a project Im showcasing on my github and linkedin for future job opportunities. Please ensure my personal security is well thought out and considered. 

### Design
Simple design for now. We can build and improve on things later, but core functionality is most important.

### Function
Planned Features
- **Rust Based OS for controlling the server and the below features
